...
INSERT INTO `cls_member` VALUES (135,9,102);
...
CREATE TABLE `member` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=103 DEFAULT CHARSET=utf8 COMMENT='老师信息';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2013-12-04 16:20:56
