...
CREATE TABLE `cls` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk` (`createmember`),
  CONSTRAINT `fk` FOREIGN KEY (`createmember`) REFERENCES `member` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `cls` VALUES (9,94,'周三语文课','张老师','362365332','每周五下午四点','浦东新区张杨路123号');
...
INSERT INTO `cls_member` VALUES (167,9,102),(168,9,105);
...
CREATE TABLE `member` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=107 DEFAULT CHARSET=utf8 COMMENT='老师信息';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2013-12-07  0:42:33
