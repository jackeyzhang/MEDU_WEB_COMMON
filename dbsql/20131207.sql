...
CREATE TABLE `cls` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk` (`createmember`),
  CONSTRAINT `fk` FOREIGN KEY (`createmember`) REFERENCES `member` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `cls` VALUES (9,94,'周三语文课','张老师','362365332','每周五下午四点','浦东新区张杨路123号'),(10,94,'2','2','2','22','2'),(11,82,'82','82','82','82','82'),(12,82,'1','2','3','4','5');
...
CREATE TABLE `member` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=114 DEFAULT CHARSET=utf8 COMMENT='老师信息';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `message` VALUES (7,-1,-1,'','2013-11-28 00:00:00','内容','标题',''),(8,-1,-1,'','2013-11-28 00:00:00','内容','标题',''),(9,-1,-1,'','2013-12-04 00:00:00','2','1',''),(10,-1,-1,'','2013-12-04 00:00:00','2','1',''),(11,-1,-1,'','2013-12-04 00:00:00','3','2',''),(13,97,97,'','2013-12-04 00:00:00','2','1',''),(14,97,97,'','2013-12-04 00:00:00','3','2','');
...
-- Dump completed on 2013-12-07 15:56:06
