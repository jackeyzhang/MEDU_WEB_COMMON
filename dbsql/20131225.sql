...
CREATE TABLE `cls` (
  ...
  CONSTRAINT `fk_teacher` FOREIGN KEY (`teacherid`) REFERENCES `member` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `cls` VALUES (32,81,'周三语文课3','张老师','362365332','时间描述','浦东新区张杨路123号');
...
CREATE TABLE `cls_member` (
  ...
  KEY `clsfk_idx` (`class`),
  KEY `memberfk_idx` (`student`),
  CONSTRAINT `clsfk` FOREIGN KEY (`class`) REFERENCES `cls` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `cls_member` VALUES (187,9,102),(188,9,110),(189,10,111),(199,11,112);
/*!40000 ALTER TABLE `cls_member` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `cls_student`
--

DROP TABLE IF EXISTS `cls_student`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `cls_student` (
  `idcls_student` int(11) NOT NULL AUTO_INCREMENT,
  `classid` int(11) NOT NULL,
  `studentid` int(11) NOT NULL,
  PRIMARY KEY (`idcls_student`),
  KEY `classfk_idx` (`classid`),
  KEY `stufk_idx` (`studentid`),
  CONSTRAINT `classfk` FOREIGN KEY (`classid`) REFERENCES `cls` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `stufk` FOREIGN KEY (`studentid`) REFERENCES `student` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=125 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `cls_student`
--

LOCK TABLES `cls_student` WRITE;
/*!40000 ALTER TABLE `cls_student` DISABLE KEYS */;
INSERT INTO `cls_student` VALUES (124,32,121);
/*!40000 ALTER TABLE `cls_student` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `member` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=106 DEFAULT CHARSET=utf8 COMMENT='老师信息';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `message` VALUES (7,-1,-1,'','2013-11-28 00:00:00','内容','标题',''),(8,-1,-1,'','2013-11-28 00:00:00','内容','标题',''),(9,-1,-1,'','2013-12-04 00:00:00','2','1',''),(10,-1,-1,'','2013-12-04 00:00:00','2','1',''),(11,-1,-1,'','2013-12-04 00:00:00','3','2','');
...
CREATE TABLE `student` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=122 DEFAULT CHARSET=utf8 COMMENT='学生信息';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `student` VALUES (116,'小孩子52','123','xiaohaizi2@139.com',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(121,'333','2','2@1.com','','2013-12-11 00:00:00','男','','2','','','','','','','');
...
-- Dump completed on 2013-12-25 23:13:56
