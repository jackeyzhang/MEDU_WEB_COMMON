...
public class TeacherDAO extends BaseHibernateDAO  {
	...
	public static final String CLASSSALARY = "classsalary";
	...
	public List findByBasesalary(Object basesalary
	) {
		return findByProperty(BASESALARY, basesalary
		);
	}
	
	public List findByClasssalary(Object classsalary
	) {
		return findByProperty(CLASSSALARY, classsalary
		);
	}
